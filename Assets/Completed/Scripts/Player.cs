...
namespace Completed
{
	...
	{
		public float unpauseDelay = 0.1f;			//Delay to unpause
		...
		private void Restart ()
		{
			...
			PlayerPrefs.SetInt ("level", GameManager.instance.level+1);
			PlayerPrefs.SetInt ("food", GameManager.instance.playerFoodPoints);
			PlayerPrefs.Save();
		}
